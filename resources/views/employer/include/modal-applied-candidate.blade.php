                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="pe-4">
                                ...
                                @if ($applied->show_contact)
                                    <a href="mailto:{{ $applied->user->email }}"
                                        class="text-success">
                                        {{ $applied->user->email }}
                                    </a>
                                @else
                ...
                @if ($applied->attachment)
                    ...
                    @if ($applied->show_contact)
                        <div>
                            ...
                            <a href="{{ asset($applied->attachment) }}" target="_blank"
                                class="text-success">
                                {{ __('download') }} {{ __('attachment') }}
                            </a>
                        </div>
                    @else
                        <div>
